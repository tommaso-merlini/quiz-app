...
//                                     .object({
//                                         first: z.object({
//                                             text: z.string().describe("the first answer of the test"),
//                                             isTrue: z
//                                                 .boolean()
...
//                                             text: z
//                                                 .string()
//                                                 .describe("the second answer of the test"),
//                                             isTrue: z
//                                                 .boolean()
//                                                 .describe("true if the response is true, false if not"),
//                                         }),
//                                         third: z.object({
//                                             text: z.string().describe("the third answer of the test"),
//                                             isTrue: z
//                                                 .boolean()
//                                                 .describe("true if the response is true, false if not"),
//                                         }),
...
//                                             text: z
//                                                 .string()
//                                                 .describe("the fourth answer of the test"),
//                                             isTrue: z
//                                                 .boolean()
//                                                 .describe("true if the response is true, false if not"),
//                                         }),
...
//           "open-ended question to the user. THIS IS NOT A QUESTION TO GET THE INTENTION OF THE USER, IT'S ONLY TO TEST THEM",
//         ),
...
//                     "mid to long open-ended question to the user. THIS IS NOT A QUESTION TO GET THE INTENTION OF THE USER, IT'S ONLY TO TEST THEM",
//                 ),
//                 trueOrFalseSchema.describe("a true/false question"),
...
export const testSchema = z.object({
  questions: z.array(
    z
      ...
      .describe(
        "You must NOT only use one type of question. For every question you come up choose the best fitting question type. (example: if it's a true/false question choose the trueOrFalseSchema, if it's an open ended question choose the textAreaSchema)",
      ),
  ),
});
